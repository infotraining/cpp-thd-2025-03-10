...
namespace LockFree
{
    ...
    {
        std::array<T, N> buffer_;
        alignas(std::hardware_destructive_interference_size) std::atomic<unsigned int> head_{0};
        alignas(std::hardware_destructive_interference_size) std::atomic<unsigned int> tail_{0};
